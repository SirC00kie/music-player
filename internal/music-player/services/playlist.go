...
func (ps *PlaylistService) play() {
	...
	if ps.Playlist.CurrentTime >= ps.Playlist.CurrentSong.Value.(*models.Song).Duration {
		...
		fmt.Printf("Now playing: %s by %s. Time left: %v\n", song.Title, song.Author, ps.Playlist.CurrentSong.Value.(*models.Song).Duration-ps.Playlist.CurrentTime)
...
func (ps *PlaylistService) NextSong() error {
	...
	if ps.Playlist.CurrentSong.Next() != nil {
...
func (ps *PlaylistService) PrevSong() error {
	...
	if ps.Playlist.CurrentSong.Prev() != nil {
